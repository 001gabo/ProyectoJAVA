...
public class Jplista_libros extends javax.swing.JPanel {
    ...
    public Jplista_libros( List<List<String>> milista_libros, int numero, int opcion, String texto_busqueda){
        initComponents();
        set_labels();
        set_panels();
        numero_resultados = numero;
        opcion_busqueda = opcion;
        this.texto_busqueda = texto_busqueda;
        pintar_labels(milista_libros, numero);
    }
    ...
    private void initComponents() {
        ...
        JPVermas = new javax.swing.JPanel();
        ...
        JPVermas.setBackground(new java.awt.Color(153, 255, 153));
        JPVermas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                JPVermasMouseReleased(evt);
            }
        });

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("VER MAS");
        JPVermas.add(jLabel2);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(JPanelcuadro4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(187, 187, 187)
                        .addComponent(JPVermas, javax.swing.GroupLayout.PREFERRED_SIZE, 161, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(JPanelcuadro5, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(JPVermas, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(16, Short.MAX_VALUE))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void pintar_labels(List<List<String>> milista_libros, int numero)
    {
        this.jLabel11.setText("Número de coincidencias: " + numero);
        JLabel ltemporal;
        ...
        for(int x = 0; x < lista_libros.size(); x++)
        {
            ...
            ltemporal.setText(String.valueOf((x + 1 + indice_busqueda)));
        ...
        if(lista_libros.size() < 5)
        {
            ...
            this.JPVermas.setVisible(false);
        } 
    }
    ...
    private void JPVermasMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JPVermasMouseReleased
        
        indice_busqueda = indice_busqueda + 5;
        System.out.println("busqueda" + indice_busqueda + ", " + texto_busqueda + ", opcion" + opcion_busqueda);
        lista_libros = miconexion.bucscarlibro(texto_busqueda, indice_busqueda, opcion_busqueda);
        pintar_labels(lista_libros, numero_resultados);
        this.revalidate();
        this.repaint();
    }//GEN-LAST:event_JPVermasMouseReleased
    private void seleccionar_libro(int numero)
    {
        List<String> temporal = lista_libros.get(numero);
        String snumero = temporal.get(0);
        int id_libro = Integer.parseInt(snumero);
        ventanaFPrestar = new JFPrestar(id_libro);
        ventanaFPrestar.setSize(ventanaFPrestar.getPreferredSize());
        ventanaFPrestar.setVisible(true);
    }
    ...
    private javax.swing.JPanel JPVermas;
